...
1. **Reduces pro-inflammatory cytokines** - Chemical messengers that promote inflammation
2. **Balances Th1/Th2 immune response** - Helps correct autoimmune imbalances
3. **Decreases microglial activation** - Calms overactive immune cells in the nervous system
4. **Supports regulatory T-cells** - Cells that help prevent autoimmune attacks
...
* Name of a[ compounding pharmacy](https://www.wellpharmapharmacy.com/compounding.html) (WellPharma!)
